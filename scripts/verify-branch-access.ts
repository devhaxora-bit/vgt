...
assert(isBranchAdminAllowedPath('/dashboard/admin/login-attempts') === false, 'login attempts blocked');
...
assert(canAccessAdminPath(branchAdmin, '/dashboard/admin/login-attempts') === false, 'branch admin ✗ login attempts');
assert(canAccessAdminPath(globalAdmin, '/dashboard/admin/audit-logs') === true, 'global admin → audit logs');
assert(canAccessAdminPath(globalAdmin, '/dashboard/admin/login-attempts') === true, 'global admin → login attempts');
